FROM php:5.6-apache
MAINTAINER bonsrik117 native app <bon.srik117@gmail.com>
...
RUN apt-get update -y && apt-get upgrade -y && apt-get dist-upgrade -y && apt-get install -y gnupg2 dirmngr gpgv
...
COPY apache/LocalSettings.php /var/www/html
