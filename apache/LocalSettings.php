<?php
# This file was automatically generated by the MediaWiki 1.24.2 installer. If you make manual changes, please keep track in case you need to recreate 
# them later.
#
...
#
# Further documentation for configuration settings may be found at: https://www.mediawiki.org/wiki/Manual:Configuration_settings Protect against web 
# entry
...
$wgSitename = "my-mediawiki"; $wgMetaNamespace = "My-mediawiki";
...
## customizing the URLs (like /w/index.php/Page_title to /wiki/Page_title) please see: https://www.mediawiki.org/wiki/Manual:Short_URL
...
$wgEnableEmail = true; $wgEnableUserEmail = true; # UPO $wgEmergencyContact = "apache@34.71.20.37"; $wgPasswordSender = "apache@34.71.20.37"; 
...
$wgLanguageCode = "en-gb"; $wgSecretKey = "4a63653df69d218cc418c82739bb49a796011a89975520b218b59f4fd3db49ed";
...
require_once "$IP/skins/CologneBlue/CologneBlue.php"; require_once "$IP/skins/Modern/Modern.php"; require_once "$IP/skins/MonoBook/MonoBook.php"; 
